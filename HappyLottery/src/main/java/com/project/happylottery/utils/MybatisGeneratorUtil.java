...
public class MybatisGeneratorUtil {
    public static void main(String[] args) {
        ...
        dataSourceConfig
                .setUrl("jdbc:mysql://127.0.0.1:3306/happy_lottery?userSSL=false&useUnicode=true&characterEncoding=UTF-8&serverTimezone=UTC")
                .setDriverName("com.mysql.cj.jdbc.Driver")
                .setUsername("root")
                .setPassword("Zhangyihe&509500")
                .setDbType(DbType.MYSQL);

        // 3、包配置
        PackageConfig packageConfig = new PackageConfig();
        packageConfig
                .setParent("com.project.happylottery")
                .setEntity("entity")
                .setService("service")
                .setMapper("mapper");
        ...
        strategyConfig
                ...
                .setInclude("t_lottery_win_info")// 设置要映射的表
